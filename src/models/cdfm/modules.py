...
class UNet_conditional(nn.Module):
    def __init__(self, c_in=1, c_out=1, time_dim=256, num_classes=None, device="cuda"):
        ...
        self.up2 = Up(256, 64)
        self.sa5 = SelfAttention(64, 25)
        self.up3 = Up(128, 64)
        self.sa6 = SelfAttention(64, 50)
        self.outc = nn.Conv2d(64, c_out, kernel_size=1)
    ...
    def forward(self, x, t, y):
        ...
        if y is not None:
            embe = self.label_emb(y)
            #embe = embe.view(-1, self.time_dim, self.time_dim)
